...
export const en: Translations = {
    ...
    subtitleStudio: {
        ...
        subtitle: 'Generate subtitles from audio with Gemini',
        open: 'Subtitle Studio',
        apiKeyLabel: 'Gemini API key',
        apiKeyPlaceholder: 'Paste your key',
        apiKeyHelp: 'Stored only in this browser. Never sent to our servers.',
        apiKeyGet: 'Get a key from Google AI Studio',
        apiKeyShow: 'Show',
        apiKeyHide: 'Hide',
        apiKeyMissing: 'Enter your Gemini API key to unlock subtitle generation.',
        apiKeySaved: 'Key saved in this browser',
        fileDrop: 'Drop an audio file here',
        fileBrowse: 'Choose file',
        fileDuration: 'Duration',
        fileVideoTooBig: 'This video is too large to process in the browser. Convert it to an audio file (MP3) and upload that.',
        fileVideoHint: 'Video detected - the audio will be extracted. An MP3 is faster.',
        languageLabel: 'Source language',
        languageAuto: 'Detect automatically',
        vocabularyLabel: 'Term hints',
        vocabularyPlaceholder: 'Ada, Bora, SynCinema',
        vocabularyHelp: 'Comma separated. The first 100 terms are used.',
        readabilityTitle: 'Readability',
        maxCharsLabel: 'Characters per line',
        minDurLabel: 'Minimum duration',
        sentenceOnlyLabel: 'Break at sentence ends only',
        formatsTitle: 'Output formats',
        ...
        copied: 'Copied',
        share: 'Share',
        useInPlayer: 'Use in player',
        startOver: 'Start over',
        phasePrepare: 'Preparing audio',
        phaseUpload: 'Uploading',
        phaseTranscribe: 'Transcribing',
        chunkProgress: 'Part {current} of {total}',
        retrying: 'Rate limited - retrying in {seconds}s',
        longFileWarning: 'Long file: it will be split into parts. This can take a while and use a lot of memory.',
        resultTitle: 'Result',
        resultBlocks: '{count} subtitle blocks',
        resultEmpty: 'No speech was recognised in this file.',
        errorInvalidKey: 'That API key was rejected. Check it and try again.',
        errorRateLimit: 'Too many requests. Wait a moment and try again.',
        errorQuota: 'Your Gemini quota or billing is not sufficient for this request.',
        errorServer: 'Gemini had a server problem. Try again shortly.',
